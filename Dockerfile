...
WORKDIR /app
COPY pom.xml .
RUN --mount=type=cache,id=s/9ca38fb7-806e-466c-8394-ebcc2ba25746-/root/.m2 mvn clean package -Dmaven.test.skip  && rm -r target

COPY src ./src
RUN --mount=type=cache,id=s/9ca38fb7-806e-466c-8394-ebcc2ba25746-/root/.m2 mvn package -Dmaven.test.skip
