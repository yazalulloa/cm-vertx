...
import com.yaz.cm.vertx.sse.EventSource;
import com.yaz.cm.vertx.sse.SSEHeaders;
import com.yaz.cm.vertx.sse.exceptions.ConnectionRefusedException;
...
public class EventSourceImpl implements EventSource {
	...
	public EventSource connect(String path, String lastEventId, Handler<AsyncResult<Void>> handler) {
		...
		/*HttpClientRequest request = client(path, response -> {
